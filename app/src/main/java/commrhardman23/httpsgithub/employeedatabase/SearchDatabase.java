...
public class SearchDatabase extends AppCompatActivity {
    ...
    public void searchDatabase(View vw) {
        ...
        try {
            ...
            Cursor cursor = db.query("EMPLOYEE", new String[]{"NAME", "POSITION"}, null, null, null, null, null);
    ...
    public void deleteEntry(View vw) {
        ...
        try {
            ...
            db = employeeDatabaseHelper.getWritableDatabase();
            numRowsDeleted=employeeDatabaseHelper.deleteElement(whereToDelete,elementsToDelete,)
